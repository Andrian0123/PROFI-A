...
kapt {
    ...
    // Do not add global arguments here: Room and Hilt share the same kapt run,
    // so options for one processor (e.g. room.incremental) trigger "not recognized" warnings in the other.
}

android {
    namespace = "ru.profia.app"
    compileSdk = 36

    defaultConfig {
        applicationId = "ru.profia.app"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.0.0"
